    ...
    <section id="about" className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          >
            <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl border-8 border-white bg-slate-50">
              <img 
                src="/Building.png" 
            ...
            {/* Floating Card */}
            <div className="absolute -bottom-6 -right-6 md:right-auto md:-left-6 bg-glass p-6 rounded-3xl shadow-xl border border-white/60 hidden sm:flex items-center gap-4 animate-bounce-slow">
              <div className="w-14 h-14 rounded-full bg-accent text-white flex items-center justify-center text-2xl shadow-inner">
                <FaHeartbeat />
              </div>
              <div>
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-6 tracking-tight leading-[1.1]">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent">High-Quality Healthcare</span>
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
              <div className="bg-primary-light/50 p-6 rounded-2xl border border-primary/10 hover:border-primary/30 transition-colors shadow-sm">
                <h4 className="font-bold text-primary text-lg mb-2">Our Mission</h4>
                <p className="text-gray-600 leading-relaxed">To provide accessible, affordable, and high-quality healthcare to our entire community.</p>
              </div>
              <div className="bg-accent-light/50 p-6 rounded-2xl border border-accent/10 hover:border-accent/30 transition-colors shadow-sm">
                <h4 className="font-bold text-accent text-lg mb-2">Our Vision</h4>
                <p className="text-gray-600 leading-relaxed">To be the most trusted and preferred healthcare partner for every family we serve.</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-6">
              {features.map((feature, index) => (
                <div key={index} className="flex items-center gap-3 group">
                  <div className="w-10 h-10 rounded-full bg-slate-50 border border-gray-100 text-primary flex items-center justify-center shrink-0 group-hover:bg-primary group-hover:text-white transition-colors duration-300 shadow-sm">
